...
<form method="POST" action="{{ route('employee.files.store') }}" enctype="multipart/form-data"
    x-data="{
...
>
    ...
    <!-- Tab Content -->
    <div>
        <x-employee.licenses :licensesData="$licensesData" />
        <x-employee.other_files :otherFiles="$otherFiles" />
    </div>
