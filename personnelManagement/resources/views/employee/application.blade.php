            ...
            <div class="mt-6 pt-4 border-t border-gray-200">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <form id="deleteForm" action="{{ route('employee.application.destroy') }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button
                                type="button"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="border border-gray-300 rounded-lg shadow-md p-4 flex flex-col justify-between bg-white">
            ...
            <div class="flex flex-col items-end gap-2 mt-4">
                ...
                <form action="{{ route('applicant.application.delete', $application->id) }}" method="POST" class="delete-application-form" style="display:none">
                    @csrf
                    @method('DELETE')
                    <button type="button" class="deleteApplicationBtn text-red-500 hover:text-red-700 transition mt-2" title="Delete Application">
