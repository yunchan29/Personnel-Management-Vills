        ...
        <div class="glass-effect rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <div class="mb-6">
                    ...
                    <div x-show="errors.throttle"
                         x-transition
                         class="bg-amber-50 border-l-4 border-amber-500 p-4 mt-4 rounded-lg"
                         x-cloak>
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="font-semibold text-amber-800">Too Many Attempts</p>
                                <p class="text-sm text-amber-700 mt-1" x-text="errors.throttle ? errors.throttle[0] : ''"></p>
                            </div>
                        </div>
                    </div>
                </div>
