        ...
        <div class="flex-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                <div>
                    ...
                    <select id="province" name="province" class="w-full border rounded px-3 py-2">
                        <option value="">-- Select Province --</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm text-gray-700">City / Municipality</label>
                    <select id="city" name="city" class="w-full border rounded px-3 py-2" {{ old('city', $user->city) ? '' : 'disabled' }}>
                        <option value="">-- Select City --</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm text-gray-700">Barangay</label>
                    <select id="barangay" name="barangay" class="w-full border rounded px-3 py-2" {{ old('barangay', $user->barangay) ? '' : 'disabled' }}>
