...
@if(auth()->user()->role === 'applicant')
    ...
    <div class="max-w-7xl mx-auto p-6">
        ...
        <div class="flex gap-6">
            <!-- Welcome Section -->
            <div class="flex-1 bg-white rounded-xl shadow-lg p-6 flex items-center">
                <div>
            ...
            <!-- Notification Section (Card Style) -->
            <div class="w-96">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8 mt-4">
                        ...
                        <div class="p-5 space-y-3 border-t border-gray-100">
                            ...
                            <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                                <div class="flex items-center gap-1 text-sm text-gray-600">
                                    ...
                                    <span class="font-medium">{{ $job->vacancies }} available positions</span>
                                </div>
