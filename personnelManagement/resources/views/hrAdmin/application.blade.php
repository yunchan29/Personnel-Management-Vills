...
<section class="p-6 max-w-6xl mx-auto"
    ...
    {{-- Job Postings --}}
    <div x-show="$store.applications.tab === 'postings'" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="flex items-center mb-6">
            ...
            <input type="text" id="search" name="search" class="flex-1 border border-gray-300 rounded-md p-2 text-sm" placeholder="Enter job title...">
